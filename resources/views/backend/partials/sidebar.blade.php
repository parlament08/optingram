...
{{--            @endcan--}}
{{--            @can('manage autoposting')--}}
                <li class="{{ active_class(if_route_pattern('admin.autoposting.*')) }}"><a href="{{ route('admin.autoposting.index') }}"><i class="fa fa-tags"></i> <span>@lang('labels.backend.posts.titles.main')</span></a></li>
{{--            @endcan--}}
        </ul>
        <!-- /.sidebar-menu -->
    </section>
